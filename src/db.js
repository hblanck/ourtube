...
function initDb() {
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS virtual_video_bookmarks (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      media_id TEXT NOT NULL,
      time_seconds REAL NOT NULL DEFAULT 0,
      title TEXT,
    ...
    CREATE TABLE IF NOT EXISTS virtual_video_comments (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      media_id TEXT NOT NULL,
      author_name TEXT NOT NULL DEFAULT 'Anonymous',
      comment_text TEXT NOT NULL,
    ...
    CREATE INDEX IF NOT EXISTS idx_virtual_video_bookmarks_media_id ON virtual_video_bookmarks(media_id);
    CREATE INDEX IF NOT EXISTS idx_virtual_video_bookmarks_created_at ON virtual_video_bookmarks(created_at);
    CREATE INDEX IF NOT EXISTS idx_virtual_video_comments_media_id ON virtual_video_comments(media_id);
    CREATE INDEX IF NOT EXISTS idx_virtual_video_comments_created_at ON virtual_video_comments(created_at);
